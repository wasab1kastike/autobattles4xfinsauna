...
- Persist loot-drop upgrades with additive modifiers, gate loot rolls behind the
  progression-driven drop chance (now a 10% base rate), update the loot roller
  to accept explicit roll counts, and cover the new progression module plus RNG
  gating with focused Vitest cases.
