...
export const SAUNA_TIERS: readonly SaunaTier[] = Object.freeze([
  {
    ...
    rosterCap: 3,
    description: 'Smoke-cured log benches define the Primitive Smoke Sauna with a loyal trio of attendants.',
    art: {
  ...
  },
  {
    ...
    rosterCap: 4,
    description: 'Polished timber benches power the Modern Wooden Sauna with a quartet ready to repel sieges.',
    art: {
      badge: saunaBeerUrl,
  ...
  },
  {
    ...
    rosterCap: 6,
    description: 'Radiant coils encircle the Futuristic Fission Sauna where six legends guard the löyly.',
    art: {
