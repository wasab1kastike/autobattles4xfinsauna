...
export function setupRightPanel(
  ...
  const policyTab = document.createElement('div');
  policyTab.id = 'right-panel-policies';
  policyTab.setAttribute('role', 'region');
  policyTab.setAttribute('aria-label', 'Policy ledger');
  ...
  // --- Policies ---
  const policyPanel = createPolicyPanel(policyTab, state);
