...
- **Prerequisite:** None — purchase once you can cover the Saunakunnia cost.
...
- **Prerequisite:** None — available as soon as your council approves the spend.
...
- **Prerequisite:** None — recruit immediately after unlocking the policy console.
...
## Shieldwall Doctrine
- **Prerequisite:** None — keep enough Saunakunnia ready to draft the wardens.
...
## Sauna Skin Plating
- **Prerequisite:** None — only the triple-upkeep surcharge limits when you engage it.
...
## Steam Debt Protocol
- **Prerequisite:** None — maintain the 90-bottle reserve to satisfy the treasury auditors.
